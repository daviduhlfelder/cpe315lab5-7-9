...
Thumb_Types decode(const ALL_Types data) {
  if (data.type.alu.instr.class_type.type_check == ALU_TYPE) {
    ...
    if (data.type.ld_st.instr.class_type.opA == LD_ST_REG_OPA) {} else if (data.type.ld_st.instr.class_type.opA == LD_ST_IMM_OPA) {} else if (data.type.ld_st.instr.class_type.opA == LD_ST_IMMB_OPA) {} else if (data.type.ld_st.instr.class_type.opA == LD_ST_IMMH_OPA) {} else if (data.type.ld_st.instr.class_type.opA == LD_ST_IMMSP_OPA) {} else {
...
LD_ST_Ops decode(const LD_ST_Type data) {
  ...
  } else if (data.instr.class_type.opA == LD_ST_IMMB_OPA) {} else if (data.instr.class_type.opA == LD_ST_IMMH_OPA) {} else if (data.instr.class_type.opA == LD_ST_IMMSP_OPA) {
